...
var messages = map[string]map[Lang]string{
	...
	"dash.successor.revoked": {DE: "Hier erzeugte Schlüssel werden widerrufen", EN: "Keys issued here will be revoked"},
	"dash.successor.on":      {DE: "am", EN: "on"},
	...
	"dash.usagestats.note":        {DE: "Ihr Kontingent wird in Kosten gemessen; die Verlaufsgrafik zeigt die Tokens dieses Schlüssels der letzten 30 Tage. Das Kontingent gilt für Sie, nicht für den einzelnen Schlüssel: Ein neu erzeugter Schlüssel setzt es nicht zurück.", EN: "Your allowance is measured in cost; the history chart shows the tokens this key used over the last 30 days. The allowance applies to you rather than to a single key, so generating a new key does not reset it."},
	"dash.usagestats.total":       {DE: "Gesamt", EN: "Total"},
	"admin.form.quota.add":        {DE: "Fenster hinzufügen", EN: "Add window"},
	"admin.form.quota.amount":     {DE: "Betrag", EN: "Amount"},
	"admin.form.quota.unit":       {DE: "Einheit:", EN: "Unit:"},
	...
	"dash.quota.resets":           {DE: "Zurücksetzung", EN: "Resets"},
	"dash.quota.unlimited":        {DE: "Für dieses Profil gilt kein Verbrauchslimit.", EN: "This profile has no usage limit."},
	...
	"dash.col.model.unknown":      {DE: "unbekannt", EN: "unknown"},
	...
	"admin.form.quota.hint":    {DE: "Ausgabenkontingent pro Zeitraum, z. B. 0.10. Leer bedeutet kein Limit.", EN: "Spend allowance per period, e.g. 0.10. Blank means no limit."},
	...
	"help.quota":          {DE: "Ausgabenkontingent und wie oft es zurückgesetzt wird. Anfragen schlagen fehl, sobald es aufgebraucht ist, und funktionieren nach dem Zurücksetzen wieder.", EN: "Fair-use spend allowance and how often it resets. Requests fail once it is used up, then resume at the next reset."},
