...
| `SUCCESSOR_URL`      | no       |             | Set on a portal being retired: the dashboard shows a banner sending users to this address and warning that keys issued here will be revoked |
